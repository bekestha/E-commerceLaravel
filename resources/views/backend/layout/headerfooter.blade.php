        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mx-auto">
            <li class="nav-item Pages">
              ...
              <li class="nav-item Pages">
                <a class="nav-link" href="/categories">Sub-Categoris</a>
              </li>
              <li class="nav-item Pages">
                <a class="nav-link" href="/categories">Banner</a>
              </li>
              <li class="nav-item Pages">
